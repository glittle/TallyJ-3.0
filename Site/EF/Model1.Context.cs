...
namespace TallyJ.EF
{
    ...
    public partial class TallyJ2dContext : DbContext
    {
        ...
        public virtual int UpdateVoteStatus(Nullable<int> voteRowId, string statusCode)
        {
            var voteRowIdParameter = voteRowId.HasValue ?
                new ObjectParameter("VoteRowId", voteRowId) :
                new ObjectParameter("VoteRowId", typeof(int));
    
            var statusCodeParameter = statusCode != null ?
                new ObjectParameter("StatusCode", statusCode) :
                new ObjectParameter("StatusCode", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("UpdateVoteStatus", voteRowIdParameter, statusCodeParameter);
        }
    }
}
