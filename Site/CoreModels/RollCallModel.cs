...
public class RollCallModel : DataConnectedModel
{
  ...
  {
    {
      return _people ??= PeopleInCurrentElectionQuery().ToList();
    }
  }
    ...
    bool includeAbsentees)
  {
    ...
    {
      before.Add(new RoleCallPersonInfo
        { PersonId = 0 - numBlanksBefore, LastName = "&nbsp;", VotingMethod = "BLANK" });
      numBlanksBefore--;
    }
    ...
    {
      after.Add(new RoleCallPersonInfo
        { PersonId = firstBlankAfter + offset++, LastName = "&nbsp;", VotingMethod = "BLANK" });
      numBlanksAfter--;
    }
    ...
    var roleCallPeople = people.Select(p => new RoleCallPersonInfo
    {
      ...
      VotingMethod = p.VotingMethod.ToString(),
  ...
  private class RoleCallPersonInfo
  {
