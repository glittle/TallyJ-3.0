...
namespace EntityFramework.Extensions
{
    ...
    public static class CacheExtensions
    {
      ...
      /// </returns>
      public static List<TEntity> FromCache<TEntity>(this IQueryable<TEntity> query, out CacheKey cacheKey, CachePolicy cachePolicy = null, IEnumerable<string> tags = null)
            where TEntity : class
        {
            string key = query.GetCacheKey();
            cacheKey = new CacheKey(key, tags ?? Enumerable.Empty<string>());
            ...
            where TEntity : class
        {
          ...
          return query
                .Take(1)
                .FromCache(out cacheKey, cachePolicy, tags)
                .FirstOrDefault();
        }
